                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header blue lighter bigger">
                                        <i class="ace-icon fa fa-wechat green"></i>
                                        <b>${webTitle}-登录</b>
                                    </h4>
                                    <div class="space-6"></div>
                                    <form id="loginForm" action="checkLogin.htm" method="post">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <span id="lblMessage" class="errMsg" style="display: none"> 账号或密码输入错误！ </span>
                                                        </span>
                                                <div class="space"></div>
                                                <div class="clearfix">
                                                    <label class="inline">
                                                        <input type="checkbox" class="ace" id="chk"/>
                                                ...
                                                <label class=" clearfix">
															...
															<span class="inline input-icon input-icon-right">
                                                                版权所有 © 2017
                                                                <a href="http://#" target="_blank">技术研发中心</a>
                                                            </span>
														</span>
                                                </label>
                                            </label>
